...
public class Statistique implements Serializable {
    ...
    public fr.eni.geekoquizz.bo.Statistique toStatistique()
    {
        return new fr.eni.geekoquizz.bo.Statistique(
          getId(),getDate(), getNbPoints(), getNbCorrect(), getQuizz().toQuizz(), getJoueur().toUtilisateur()
        );
    }
